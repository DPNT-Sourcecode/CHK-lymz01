def checkout(skus):
    ...
    # Create counters of A's, B's, E's and F's. After summing all variables we reduce
    ...
    prices_dict = {"A": 50, "B": 30, "C": 20, "D": 15, "E": 40, "F": 10}
    ...
    f_s_free = (f_s // 3)
    f_s_discount = f_s_free * prices_dict["F"]
    ...
    price_counter = price_counter - (a_s_discount +
                                     e_s_discount_to_b +
                                     b_s_discount +
                                     f_s_discount)
